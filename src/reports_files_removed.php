<?php
  ...
  $gv_files = $go_file_manager->get_count(2);

  // Create navigation
  $go_navigation = new navigation("/reports/$gv_section/$gv_report", $lv_page, $gv_files);

  // Get no removed files
  $gt_files = $go_file_manager->get_removed($go_navigation->get_rows(), $go_navigation->get_offset());
