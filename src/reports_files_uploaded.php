<?php
  ...
  $gv_files = $go_file_manager->get_count();

  // Create navigation
  $go_navigation = new navigation("/$gv_page/$gv_section/$gv_report", $lv_page, $gv_files);

  // Get active files
  $gt_files = $go_file_manager->get_uploaded($go_navigation->get_rows(), $go_navigation->get_offset());
...
<head>
  ...
  <title>Закаченные файлы</title>
  <script type="text/javascript" src="/js/navigate.js"></script>
  <script type="text/javascript" src="/js/jquery/jquery.js"></script>
  <script type="text/javascript" src="/js/jquery/jquery.tablesorter.js"></script>
	<script type="text/javascript">$(function() { $("#files").tablesorter() });</script>
</head>
<body>
